...
"""
Usage:
  00_countmat.py --log1p_cpm_data=<cpm_data> --gsea_bp=<gsea_bp> --gene_set=<gene_set> [options]

Mandatory arguments:
--log1p_cpm_data=<cpm_data>                 cpm adata
...
count_mat = pd.read_csv(log1p_cpm_data,index_col=0 ) #count per million data
